...
export default function Footer() {
  return (
    <footer className="bg-[#212121] py-14 text-white">
      <Container>
        <div id="about" className="grid place-items-center sm:text-left text-center lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
          <img src={logo} alt="Grant canyon" className="w-50 h-30 rounded-tl-lg rounded-br-[400px] rounded-tr-[400px]" />
