        ...
        <div className="bg-gray-200">
            <section className="parent-section">
                {theServices && theServices.map((services, index) => (
                    <div key={index} className="card mt-5 flex flex-col lg:flex-row mx-10 md:mx-20 lg:mx-52 rounded-lg bg-white">
                            ...
                            <div className="top flex flex-row justify-between my-2 ma-5 mx-5 text-gray-500">
                                <div className="tag">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="ml-2 text-sm font-bold text-gray-900 dark:text-white">{services.averageRate}</p>
                                ...
                                <div className="date text-xs">${services.price}</div>
                            </div>

                            <div className="middle mx-2 my-5">
                                <div className="author flex mx-2 my-5">
                                    <img src={services.pic}
                                        alt="pic" className="profile mr-7 rounded-lg" width='70px' hights='20px'></img>
                                    <div className="author-details text-sm">
                                        <p className="author-name">provider: {services.name}</p>
                                        <p className="author-email"> {services.email}</p>
                                        <p className="author-phone"> {services.phone}</p>
                                    </div>

                                </div>

                                <h2 className="title text-2xl font-bold mx-2">{services.serviceCategory},{services.providerCoveredCities}</h2>
            ...
            text-center  ">Chat</button>

                                <button data-modal-toggle="defaultModal" type="button"
                                    className="text-white bg-teal-800 hover:bg-teal-600 focus:ring-4 
            focus:outline-none  font-medium rounded-lg text-sm px-3 py-3 m-2
            text-center  ">Service reservation</button>
