  ...
  return (
    <div className="relative z-40">
      <input
        ...
        onBlur={focusHandler}
        className="bg-black text-white opacity-50 focus:bg-opacity-100 border-[1px] border-white outline-none px-4 py-2 rounded-md sm:w-[500px] w-[300px] placeholder-white"
      />
      {focusBox && (
