    ...
    <div>
      ...
      <div className="flex items-center justify-center min-h-screen ">
        <div className="rounded overflow-hidden justify-center bg-white ">
          ...
          <ul>
            <div className="p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-3 gap-5">
                        ...
                        <div className="flex-1 p-4">
                          <div className="block bg-white overflow-hidden border-2 h-full">
                            ...
                            <div className="p-4 flex flex-wrap items-center">
                              ...
                              <button className="px-4 py-2 font-semibold text-white bg-gray-900 rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-opacity-50" onClick={() => dispatch(deleteService(service.id))}>Delete Service</button>
                            </div>
                          </div>
                        </div>
